...
export function ComputerUseApproval(t0) {
    ...
    if ($[0] !== onDone || $[1] !== request) {
        t1 = request.tccState ? React.createElement(ComputerUseTccPanel, { tccState: request.tccState, onDone: () => onDone(DENY_ALL_RESPONSE) }) : React.createElement(ComputerUseAppListPanel, { request: request, onDone: onDone });
        $[0] = onDone;
        $[1] = request;
        $[2] = t1;
    }
...
function ComputerUseTccPanel(t0) {
    ...
    let t6;
    if ($[12] !== t3 || $[13] !== t5) {
        t6 = React.createElement(Box, { flexDirection: "column" },
            t3,
            t5);
        $[12] = t3;
        $[13] = t5;
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = React.createElement(Text, { dimColor: true }, "Grant the missing permissions in System Settings, then select \"Try again\". macOS may require you to restart Claude Code after granting Screen Recording.");
        $[15] = t7;
    }
    else {
        t7 = $[15];
    ...
    if ($[16] !== onChange || $[17] !== onDone || $[18] !== options) {
        t8 = React.createElement(Select, { options: options, onChange: onChange, onCancel: onDone });
        $[16] = onChange;
        $[17] = onDone;
        $[18] = options;
        $[19] = t8;
    ...
    let t9;
    if ($[20] !== t6 || $[21] !== t8) {
        t9 = React.createElement(Box, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1 },
            t6,
            t7,
            t8);
        $[20] = t6;
    ...
    let t10;
    if ($[23] !== onDone || $[24] !== t9) {
        t10 = React.createElement(Dialog, { title: "Computer Use needs macOS permissions", onCancel: onDone }, t9);
        $[23] = onDone;
        $[24] = t9;
        $[25] = t10;
    }
...
function ComputerUseAppListPanel(t0) {
    ...
    if ($[19] !== request.reason) {
        t12 = request.reason ? React.createElement(Text, { dimColor: true }, request.reason) : null;
        $[19] = request.reason;
        $[20] = t12;
    }
    else {
    ...
    if ($[21] !== checked || $[22] !== request.apps) {
        ...
        if ($[24] !== checked) {
            t14 = a_3 => {
                ...
                if (!resolved) {
                    return React.createElement(Text, { key: a_3.requestedName, dimColor: true },
                        "  ",
                        figures.circle,
                        " ",
                        a_3.requestedName,
                        " ",
                        React.createElement(Text, { dimColor: true }, "(not installed)"));
                }
                if (a_3.alreadyGranted) {
                    return React.createElement(Text, { key: resolved.bundleId, dimColor: true },
                        "  ",
                        figures.tick,
                        " ",
                        resolved.displayName,
                        " ",
                        React.createElement(Text, { dimColor: true }, "(already granted)"));
                }
                const sentinel = getSentinelCategory(resolved.bundleId);
                const isChecked = checked.has(resolved.bundleId);
                return React.createElement(Box, { key: resolved.bundleId, flexDirection: "column" },
                    React.createElement(Text, null,
                        "  ",
                        isChecked ? figures.circleFilled : figures.circle,
                        " ",
                        resolved.displayName),
                    sentinel ? React.createElement(Text, { bold: true },
                        "    ",
                        figures.warning,
                        " ",
                        SENTINEL_WARNING[sentinel]) : null);
            };
            $[24] = checked;
            $[25] = t14;
        }
    ...
    let t14;
    if ($[26] !== t13) {
        t14 = React.createElement(Box, { flexDirection: "column" }, t13);
        $[26] = t13;
        $[27] = t14;
    }
    else {
    ...
    if ($[28] !== requestedFlagKeys) {
        t15 = requestedFlagKeys.length > 0 ? React.createElement(Box, { flexDirection: "column" },
            React.createElement(Text, { dimColor: true }, "Also requested:"),
            requestedFlagKeys.map(_temp4)) : null;
    ...
    if ($[30] !== request.willHide) {
        t16 = request.willHide && request.willHide.length > 0 ? React.createElement(Text, { dimColor: true },
            request.willHide.length,
            " other",
            " ",
            plural(request.willHide.length, "app"),
            " will be hidden while Claude works.") : null;
        $[30] = request.willHide;
        $[31] = t16;
    }
    else {
    ...
    if ($[35] !== options || $[36] !== t17 || $[37] !== t18) {
        t19 = React.createElement(Select, { options: options, onChange: t17, onCancel: t18 });
        $[35] = options;
        $[36] = t17;
        $[37] = t18;
        $[38] = t19;
    ...
    if ($[39] !== t12 || $[40] !== t14 || $[41] !== t15 || $[42] !== t16 || $[43] !== t19) {
        t20 = React.createElement(Box, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1 },
            t12,
            t14,
            t15,
            t16,
    ...
    let t21;
    if ($[45] !== t11 || $[46] !== t20) {
        t21 = React.createElement(Dialog, { title: "Computer Use wants to control these apps", onCancel: t11 }, t20);
        $[45] = t11;
        $[46] = t20;
        $[47] = t21;
    }
...
function _temp4(flag) {
    return React.createElement(Text, { key: flag, dimColor: true },
        "  ",
        "\u00B7 ",
        flag);
}
